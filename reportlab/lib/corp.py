...
#$Header: /tmp/reportlab/reportlab/lib/corp.py,v 1.5 2001/10/15 13:44:38 rgbecker Exp $
...
__version__=''' $Id: corp.py,v 1.5 2001/10/15 13:44:38 rgbecker Exp $ '''
...
class RL_CorpLogo(Widget):
	...
	def draw(self):
		...
		self._paintLogo(g,fillColor=fillColor)
		g.skew(kx=10, ky=0)
		g.shift(0,35.5)
		G = Group()
		G.add(g)
