...
class ParagraphCorners(unittest.TestCase):
    ...
    def test1(self):
        ...
        story.append(Paragraph('''T<i>hi</>s shoul<font color=red>d b</font>e <b>ORDINARY</b> text.''',style=bt))
        story.append(Paragraph('''T<i>hi</>s shoul<font color=red>d b</font>e <b>LOWER</b> text.''',style=btL))
        story.append(Paragraph('''T<i>hi</>s shoul<font color=red>d b</font>e <b>upper</b> text.''',style=btU))
        story.append(Paragraph('''T<i>hi</>s shoul<font color=red>d b</font>e <b>cAPITALIZED</b> text.''',style=btC))
