...
#$Header: /tmp/reportlab/reportlab/platypus/paragraph.py,v 1.39 2000/12/10 11:57:42 andy_robinson Exp $
__version__=''' $Id: paragraph.py,v 1.39 2000/12/10 11:57:42 andy_robinson Exp $ '''
import string
