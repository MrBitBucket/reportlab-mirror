...
#$Header: /tmp/reportlab/reportlab/graphics/renderPS.py,v 1.17 2002/07/03 10:21:07 rgbecker Exp $
__version__=''' $Id: renderPS.py,v 1.17 2002/07/03 10:21:07 rgbecker Exp $ '''
import string, types
