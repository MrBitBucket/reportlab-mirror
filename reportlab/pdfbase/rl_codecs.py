...
class RL_Codecs:
    ...
    def _256_exception_codec((exceptions,rexceptions)):
        ...
        class Codec(codecs.Codec):
            def encode(self,input,errors='strict',codecs=codecs,encoding_map=encoding_map):
                return codecs.charmap_encode(input,errors,encoding_map)

            def decode(self,input,errors='strict',codecs=codecs,decoding_map=decoding_map):
