...
#$Header: /tmp/reportlab/reportlab/docs/userguide/genuserguide.py,v 1.8 2001/12/11 11:17:48 rgbecker Exp $

__version__=''' $Id: genuserguide.py,v 1.8 2001/12/11 11:17:48 rgbecker Exp $ '''
