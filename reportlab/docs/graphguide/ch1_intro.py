...
#$Header: /tmp/reportlab/reportlab/docs/graphguide/ch1_intro.py,v 1.3 2001/11/07 14:01:23 johnprecedo Exp $
...
to the use of the ReportLab Graphics sub-package.  Some previous programming experience
