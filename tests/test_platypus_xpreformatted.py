...
class WrappingTestCase(unittest.TestCase):
	...
	code = """
<b><font color="grey">#Copyright ReportLab Europe Ltd. 2000-2004
#see license.txt for license details
#history http://www.reportlab.co.uk/cgi-bin/viewcvs.cgi/public/reportlab/trunk/reportlab/platypus/xpreformatted.py</font>
<font color="red">__version__=''' $Id: xpreformatted.py 3866 2011-06-27 13:08:20Z rgbecker $ '''
__doc__='''A 'rich preformatted text' widget allowing internal markup'''</font>

<font color="blue">import string
from types import StringType, ListType
...
from flowables import _dedenter</font>

<font color="green">class XPreformatted(Paragraph):
...
"""
        ...
        story.append(XPreformatted(code,normalStyle,dedent=0, maximumLineLength=75))

        doc = MyDocTemplate(outputfile('test_platypus_xpreformatted.pdf'))
