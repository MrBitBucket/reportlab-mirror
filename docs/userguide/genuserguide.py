...
#$Header: /tmp/reportlab/docs/userguide/genuserguide.py,v 1.50 2001/11/05 13:36:39 johnprecedo Exp $

__version__=''' $Id: genuserguide.py,v 1.50 2001/11/05 13:36:39 johnprecedo Exp $ '''
