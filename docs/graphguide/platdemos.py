...
#history http://cvs.sourceforge.net/cgi-bin/cvsweb.cgi/docs/userguide/platdemos.py?cvsroot=reportlab
#$Header: /tmp/reportlab/docs/graphguide/Attic/platdemos.py,v 1.1 2001/03/29 07:15:25 dinu_gherman Exp $
