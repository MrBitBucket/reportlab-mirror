...
#history http://cvs.sourceforge.net/cgi-bin/cvsweb.cgi/docs/graphguide/platdemos.py?cvsroot=reportlab
#$Header: /tmp/reportlab/docs/graphguide/Attic/platdemos.py,v 1.2 2001/04/05 09:30:11 rgbecker Exp $
