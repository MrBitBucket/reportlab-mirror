...
#$Header: /tmp/reportlab/docs/reference/genreference.py,v 1.1 2001/10/05 00:46:33 andy_robinson Exp $
__version__=''' $Id: genreference.py,v 1.1 2001/10/05 00:46:33 andy_robinson Exp $ '''
__doc__ = """
